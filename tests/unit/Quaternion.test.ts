...
describe('Quaternion', () => {
  ...
  describe('Interpolation', () => {
    ...
    it('squad interpolates through keyframes', () => {
      ...
      const d = Quaternion.fromAxisAngle(new Vector3(0, 1, 0), Math.PI * 3 / 4)
  ...
  describe('Utility Methods', () => {
    ...
    it('checks identity', () => {
      ...
      expect(Quaternion.fromAxisAngle(new Vector3(0, 1, 0), 0.1).isIdentity()).toBe(false)
    })
...
describe('DualQuaternion', () => {
  ...
  it('clones dual quaternion', () => {
    const dq1 = DualQuaternion.fromRotationTranslation(Quaternion.identity(), new Vector3(1, 2, 3))
    const dq2 = dq1.clone()
    expect(dq2.real.w).toBe(dq1.real.w)
  })

  it('multiplies dual quaternions', () => {
    const dq1 = DualQuaternion.fromRotationTranslation(Quaternion.identity(), new Vector3(1, 0, 0))
    const dq2 = DualQuaternion.fromRotationTranslation(Quaternion.identity(), new Vector3(0, 1, 0))
  ...
  it('normalizes dual quaternion', () => {
    const dq = DualQuaternion.fromRotationTranslation(Quaternion.identity(), new Vector3(1, 2, 3))
  ...
  it('sclerp interpolates dual quaternions', () => {
    const dq1 = DualQuaternion.fromRotationTranslation(Quaternion.identity(), new Vector3(0, 0, 0))
    const dq2 = DualQuaternion.fromRotationTranslation(Quaternion.identity(), new Vector3(10, 0, 0))
  ...
  it('handles power of pure translation', () => {
    const dq = DualQuaternion.fromRotationTranslation(Quaternion.identity(), new Vector3(10, 0, 0))
    const half = dq.pow(0.5)
